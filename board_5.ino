...
const char* ssid = "ESP32_AP_5";
const char* password = "12345678";
AsyncWebServer server(80);

String subStationNames[35] = {
    // New Substations
    "TPM", "PY", "IGR", "VZ", "UKL",       // Index 0-4
    // Existing Substations
    "TLNR", "ICG", "MDUR", "VER", "ALU",   // Index 5-9
    "KLGM", "PMP", "LLI", "BXS", "GOC",    // Index 10-14
    "CII", "KFC", "VDN", "DG", "KON",      // Index 15-19
    "SDN",                                 // Index 20
    // Additional Substations
    "JS", "RT", "KA", "IS", "BV", "ML", "BFR", "KQK", "KLAD", "KGQ", "KMQ", "UAA", "MJS" , "ULL" // Index 21-33
};



bool subStationStatus[35] = {false};
...
void handlePage1(AsyncWebServerRequest *request) {
  ...
  // Station 1: Erode
  page += "<div class='section station'><h2>Station 1: Erode</h2>";
  ...
  // Sub-Stations for  Erode
  page += "<div class='section substations'><h2>Sub-Stations (Erode)</h2><div class='controls'>";
  for (int i = 0; i < 5; i++) {
  ...
  // Station 2: Tiruppur
  page += "<div class='section station'><h2>Station 2: Tiruppur</h2>";
  page += "<div class='controls'><h3>Track Controls</h3>";
...
void handlePage2(AsyncWebServerRequest *request) {
  ...
  // Station 1: Tiruchirapalli
  page += "<div class='section station'><h2>Station 1:  Tiruchirapalli</h2>";
  page += "<div class='controls'><h3>Track Controls</h3>";
  ...
  // Sub-Stations for Tiruchirapalli
  page += "<div class='section substations'><h2>Sub-Stations (Tiruchirapalli)</h2><div class='controls'>";
  for (int i = 5; i < 21; i++) {
  ...
  // Station 2: Madurai
  page += "<div class='section station'><h2>Station 2: Madurai</h2>";
  page += "<div class='controls'><h3>Track Controls</h3>";
...
void handlePage3(AsyncWebServerRequest *request) {
  ...
  // Sub-Stations
  page += "<div class='section substations'><h2>Sub-Stations (Ernakulam) </h2><div class='controls'>";
  for (int i = 21; i < 35; i++) {
...
void handleToggle(AsyncWebServerRequest *request) {
  if (request->hasParam("page") && request->hasParam("pin") && request->hasParam("type")) {
    ...
    String stationName;
    switch (pageIndex) {
      case 0: stationName = "Erode"; break;
      case 1: stationName = "Tiruppur"; break;
      case 2: stationName = "Trichirapalli"; break;
      case 3: stationName = "Madurai"; break;
    ...
    if (type == "track" || type == "front" || type == "back") {
      ...
      if ((pageIndex < 3 && subStationIndex < 35) || (pageIndex >= 3 && subStationIndex < 35)) {
...
void handleSpeedChange(AsyncWebServerRequest *request) {
  if (request->hasParam("track") && request->hasParam("speed") && request->hasParam("trackNumber")) {
    ...
    String trackName;
    switch (track) {
      case 0: stationName = "Erode"; trackName = (trackNumber == 0) ? "UpTrack 1" : "DownTrack 1"; break;
      case 1: stationName = "Tiruppur"; trackName = (trackNumber == 0) ? "UpTrack 1" : "DownTrack 1"; break;
      case 2: stationName = "Trichirapalli"; trackName = (trackNumber == 0) ? "UpTrack 1" : "DownTrack 1"; break;
      case 3: stationName = "Madurai"; trackName = (trackNumber == 0) ? "UpTrack 1" : "DownTrack 1"; break;
      case 4: stationName = "Palakad"; trackName = (trackNumber == 0) ? "UpTrack 1" : "DownTrack 1"; break;
